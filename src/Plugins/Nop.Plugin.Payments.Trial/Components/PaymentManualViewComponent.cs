...
namespace Nop.Plugin.Payments.Trial.Components
{
    [ViewComponent(Name = "PaymentTrial")]
    public class PaymentTrialViewComponent : NopViewComponent
    {
        public IViewComponentResult Invoke()
        {
            ...
            return View("~/Plugins/Payments.Trial/Views/PaymentInfo.cshtml", model);
        }
    }
}
